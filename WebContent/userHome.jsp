		...
		<body>
			...
			<nav class="ee-navbar" id="mainNav">
				...
				<div class="ee-nav-right">
					<form method="get" action="userHome.jsp" style="margin:0;">
			...
			<% if (search==null && type==null) { %>
							...
							<div class="carousel-inner">
								<div class="item active">
									...
									<div class="hero-content">
										...
										<a href="userHome.jsp?type=mobile" class="hero-cta">
											Explore Mobiles
								...
								<div class="item">
									...
									<div class="hero-content">
										...
										<a href="userHome.jsp?type=laptop" class="hero-cta">
											Shop Laptops
											<svg width="14" height="14" fill="none" stroke="currentColor"
												stroke-width="2.5" viewBox="0 0 24 24">
												<line x1="5" y1="12" x2="19" y2="12" />
								...
								<div class="item">
									...
									<div class="hero-content">
										...
										<a href="userHome.jsp?type=tv" class="hero-cta">
											Discover TVs
											<svg width="14" height="14" fill="none" stroke="currentColor"
												stroke-width="2.5" viewBox="0 0 24 24">
												<line x1="5" y1="12" x2="19" y2="12" />
				...
				<section class="categories-section">
					<div class="section-header">
						...
						<a href="userHome.jsp" class="view-all-link">View All</a>
					</div>
					<div class="categories-grid">
						<div class="cat-card">
							...
							<a href="userHome.jsp?type=mobile" class="cat-card-link"></a>
						</div>
						<div class="cat-card">
							...
							<a href="userHome.jsp?type=laptop" class="cat-card-link"></a>
						</div>
						<div class="cat-card">
							...
							<a href="userHome.jsp?type=tv" class="cat-card-link"></a>
						</div>
						<div class="cat-card">
							...
							<a href="userHome.jsp?type=camera" class="cat-card-link"></a>
						</div>
						<div class="cat-card">
							...
							<a href="userHome.jsp?type=speaker" class="cat-card-link"></a>
						</div>
					</div>
				</section>
				<% } %>
