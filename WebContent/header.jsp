...
<body style="background-color: #E6F9E6;">
	...
	String adminType = (String) session.getAttribute("admin_usertype");
	boolean isAdminContext = request.getRequestURI().matches(".*(admin|Product|Items).*");
	
	String displayRole = "guest";
	if (isAdminContext && adminType != null) {
		displayRole = "admin";
	} else if (userType != null && "customer".equalsIgnoreCase(userType)) {
		displayRole = "customer";
	} else if (adminType != null) {
		displayRole = "admin";
	}
	
	if ("guest".equals(displayRole)) { //LOGGED OUT
	%>
	...
	<%
	} else if ("customer".equals(displayRole)) { //CUSTOMER HEADER
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="./LogoutSrv?role=customer">Logout</a></li>
				</ul>
			</div>
		</div>
	</nav>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="./LogoutSrv?role=admin">Logout</a></li>
