...
<html>
<head>
<title>Add Product - Ellison Electronics</title>
<meta charset="utf-8">
...
/* Form Card */
.form-card{background:var(--white);border-radius:var(--radius-lg);box-shadow:0 2px 20px rgba(0,0,0,0.06);padding:44px;width:100%;max-width:680px}
...
.btn-submit{flex:1;padding:14px;border:none;border-radius:10px;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:600;cursor:pointer;transition:all 0.25s}
...
.btn-reset-action{background:#F0F2F5;color:var(--mid)}
.btn-reset-action:hover{background:#E0E0E0;color:var(--charcoal)}
...
<body>
    ...
    <aside class="admin-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="addProduct.jsp" class="active"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg><span>Add Product</span></a>
    ...
    <main class="admin-main">
        <div class="admin-topbar">
            <div class="topbar-left"><h1>Add Product</h1><p>Add a new product to the catalog</p></div>
                ...
                <form action="./AddProductSrv" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <textarea name="info" placeholder="Enter product description..." required></textarea>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label>Unit Price (&#8377;)</label>
                            <input type="number" placeholder="Enter Unit Price" name="price" required>
                        </div>
                        <div class="form-group">
                            <label>Stock Quantity</label>
                            <input type="number" placeholder="Enter Stock Quantity" name="quantity" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                    ...
                    <div class="form-actions">
                        <button type="reset" class="btn-submit btn-reset-action">Reset</button>
                        <button type="submit" class="btn-submit btn-primary-action">Add Product</button>
                    </div>
                </form>
            </div>
        </div>
