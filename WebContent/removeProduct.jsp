...
<html>
<head>
<title>Remove Product - Ellison Electronics</title>
<meta charset="utf-8">
...
/* Danger icon */
.danger-icon-wrap{width:64px;height:64px;border-radius:50%;background:rgba(224,49,49,0.08);display:flex;align-items:center;justify-content:center;margin:0 auto 24px;color:var(--danger)}
...
.form-group input:focus{border-color:var(--danger);box-shadow:0 0 0 3px rgba(224,49,49,0.1);background:var(--white)}
...
.btn-danger-action{background:var(--danger);color:var(--white)}
.btn-danger-action:hover{background:#C92A2A;transform:translateY(-1px);box-shadow:0 4px 16px rgba(224,49,49,0.3)}
...
<body>
    ...
    <aside class="admin-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="removeProduct.jsp" class="active"><svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg><span>Remove Product</span></a>
    ...
    <main class="admin-main">
        <div class="admin-topbar">
            <div class="topbar-left"><h1>Remove Product</h1><p>Delete a product from the catalog</p></div>
            <div class="admin-avatar">A</div>
        </div>
        <div class="admin-content">
            <div class="form-card">
                <div class="danger-icon-wrap">
                    <svg width="32" height="32" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg>
                </div>
                <h2 style="text-align:center;">Product Deletion</h2>
                <p class="subtitle" style="text-align:center;">Enter the product ID to permanently remove it</p>
                ...
                <form action="./RemoveProductSrv" method="post">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-submit btn-danger-action">Remove Product</button>
                    </div>
                </form>
            </div>
        </div>
